export class Participant {
    ...
    constructor(data?: Partial<Participant>) {
        ...
        // ?? retourner la valeur de droite si valeur de gauche est null ou undefined(nullish coalescing operator)
        this.matricule = data?.matricule ?? 0;
        // || retourner la valeur de droite si valeur de gauche est falsy (false, 0, '', null, undefined, NaN)
