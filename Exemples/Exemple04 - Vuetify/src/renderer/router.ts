...
import Accueil from "./components/Accueil.vue"; // Importation des composants de la page accueil
...
const routes = [
    ...
    {path: '/accueil', name:'Accueil', component: Accueil}, // Définition de la route Accueil
    {path: '/todo', name:'TodoExample', component: TodoExample} // Définition de la route pour l'exemple de todo
];
